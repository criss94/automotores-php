<?php 
	...
	$sql="SELECT modelo,version,anio,km,combustible,provincia,ciudad,precio,descripcion,foto1,foto2,foto3,foto4,foto5,foto6 FROM usados WHERE id_usados=".$id_usados;
	$resultado=mysqli_query($link,$sql) or die(mysqli_error($link));

	//muestreo del nombre de la marca llamando a la tabla categorias
	$sql="SELECT cat_nombre FROM categorias_usados WHERE cat_id=".$cat_id;
	...
	<section>
		<article>
			...
			<div class="muestreo-autos-old" style="background-image: url(logos/body.jpg);background-repeat: no-repeat;">
				...
				<div class="guia-nav">
					<a href="index.php">Inicio » </a><a href="catalogo-usados.php">Catálogo » </a><a href="panel-usados.php?cat_id=<?php echo $cat_id; ?>"><?php echo $fila1["cat_nombre"]; ?> » </a><a href=""><?php echo $fila["modelo"]; ?> » </a><span><?php echo $fila["version"]; ?></span>
				</div>	
	...
	<div class="vistazo">
		<div class="vista-slider">
			<div id="wowslider-container1">
				<div class="ws_images">
					<ul>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto1"]; ?>" alt="1" title="1" id="wows1_0"/></li>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto2"]; ?>" alt="2" title="2" id="wows1_1"/></li>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto3"]; ?>" alt="3" title="3" id="wows1_2"/></li>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto4"]; ?>" alt="4" title="4" id="wows1_3"/></li>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto5"]; ?>" alt="5" title="5" id="wows1_4"/></li>
			<li><img src="data1/imagesUsados/<?php echo $fila["foto6"]; ?>" alt="6" title="6" id="wows1_5"/></li>
					</ul>
			</div>
				</div>
						...
						<h4><?php echo $fila["anio"]," | ",number_format($fila["km"],3)," km"; ?></h4>
						<p><?php echo $fila["combustible"]," | ",$fila["provincia"]," ",$fila["ciudad"]; ?></p>
						<h2> $ <?php echo number_format($fila["precio"],3); ?></h2>
				
				<div class="iconos-tecnicos">
				<a href=""><img src="logos/destornillador.png" alt="">Ficha Técnica</a>
				<a href=""><img src="logos/velocimetro.png" alt="">Equipamiento</a>
				</div>
				<!--#################################################################
				######### formulario ################################################
				###################################################################-->
				<form action="procesa-form-concesionaria.php" method="POST" id="val-concesionaria">
					...
					<table id="form-concesionaria">
						...
						<tr>
							...
							<td><input type="tel" name="telefono" placeholder="Cod Area + Número" value="" required></td>
						</tr>
						<?php 
				...
				<!-- muestreo de la informacion y equipamiento del coche -->
						...
						<div class="info-ficha-tecnica">
							<div class="titulo">Ficha Técnica</div>
								<p class="info">Faltan cargar los Datos</p>
						</div>
						<div class="info-ficha-tecnica">
							<div class="titulo">Equipamiento</div>
								<p class="info">Faltan cargar los Datos</p>
						</div>
