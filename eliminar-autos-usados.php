<?php 
	...
	$id_usados=$_POST["id_usados"];
	require "conexion.php";
	$sql="DELETE FROM usados WHERE id_usados=".$id_usados;
			...
			?>	
				<div id="view-add">
					<div class="content-add">
						...
						<p class="p-aviso"> Lo sentimos,hubo un eliminar los datos, ó los datos ya fueron eliminados, revise en la categoria correspondiente según la marca.</p>
						<a href="catalogo-usados.php" class="s-salir">Salir</a>
						</div>
