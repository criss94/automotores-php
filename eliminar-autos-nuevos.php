<?php 
	...
	$sql="DELETE FROM nuevos WHERE id_nuevos=".$id_nuevos;
			...
			?>	
				<div id="view-add">
					<div class="content-add">
						<div class="suceful">
						<a href="config-nuevos.php" class="v-volver">volver</a>
						<img src="logos/error.jpg">
						<h3 class="aviso">Importante!</h3>
						<p class="p-aviso"> Lo sentimos,hubo un problema al eliminar los datos, ó los datos ya fueron eliminados, revise en la categoria correspondiente según la marca.</p>
